                ...
                <form action="{{ route('subscriptions.update', $subscription) }}" method="post">
                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                <label for="subscription_name" class="leading-7 text-sm text-gray-600 font-semibold">サービス名 <span class="text-red-500">*</span></label>
                        ...
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <select id="billing_day" name="billing_day" required
                                    ...
                                    @for($i = 1; $i <= 31; $i++)
                                        <option value="{{ $i }}" {{ (int) old('billing_day', $subscription->billing_day) === $i ? 'selected' : '' }}>
                                            毎月{{ $i }}日
                                        </option>
                                    @endfor
                                </select>
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <input type="text" id="category" name="category" required
                                    ...
                                    value="{{ old('category', $subscription->category) }}">
                            </div>
                        </div>
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                <label for="notes" class="leading-7 text-sm text-gray-600 font-semibold">メモ</label>
                                <textarea id="notes" name="notes"
                                    ...
                                    value="{{ old('memo', $subscription->memo) }}"
                                    ></textarea>
                            </div>
                        </div>
